...
async def create_source_file_structure():
    ...
    could use mongodb or postgresql 
    keep things simple!
...
async def authentication():
    """
    Implement JWT authentication with FastAPI dependency 
...
async def authorization():
    """
    With FastAPI dependency feature,
    create RBAC (role base access control) system
...
async def deployment():
    """
    With FastApi lib, uvicorn, gunicorn, 
